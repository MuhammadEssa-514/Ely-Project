...
const navigation = {
  ...
  QuickLinks: [
    ...
    { name: "Auctions", href: "#" },
    { name: "About", href: "#" },
    { name: "Submit for auction", href: "#" },
    { name: "How it works", href: "#" },
    { name: "Get an Email", href: "#" },
  ],

  contactus: [
    {
      icon: <MdEmail className="text-[#0C50CA] w-[28px] h-[28px] " />,
      name: "post@auksjonen.no",
      href: "#",
    },
    {
      icon: (
        <BsFillTelephoneFill className="text-[#0C50CA] w-[28px] h-[28px]  " />
      ),
      name: "+47 33 30 05 40",
      href: "#",
    },
    {
      icon: <ImLocation2 className="text-[#0C50CA] w-[100%] h-[50px]" />,
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-xl font-semibold leading-6 text-[#0C50CA] font-[Poppins] font-size-[28px] font-weight: 600;">
                  Categories
                </h3>
                <ul className="list mt-6 space-y-4">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-xl font-semibold leading-6 text-[#0C50CA]">
                  QuickLinks
                </h3>
                <ul className="list mt-6 space-y-4">
